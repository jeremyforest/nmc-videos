...
class YoutubeUploader:
    """
    Parts of this is copy/paste from youtube API queries examples.
    """
    def __init__(self):
        ...
        self.MISSING_CLIENT_SECRETS_MESSAGE = "missing client secret file"
        self.VALID_PRIVACY_STATUSES = ("public", "private", "unlisted")


    def get_authenticated_service(self, data):
        ...
        def initialize_upload(self, youtube, data):
            tags = None
            if data["keywords"]:
            ...
            response_id = self.resumable_upload(insert_request)
            return response_id
    ...
    def upload(self, file, title, description, category, keywords, privacyStatus):
        ...
        youtube = self.get_authenticated_service(data)
        try:
            response_id = self.initialize_upload(youtube, data)
        except HttpError as e:
